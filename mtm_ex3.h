...
/**
 * mtmPrintErrorMessagedasdsad - prints an error message into the given output
 * channel Use the standard error channel to print error messages.
 *
 ...
 * @param friendsNames - a list of strings containing the names of the friends
 * of the user
 * @param seriesNames - a list of strings containing the names of the series
 * that the user likes
 * @returns NULL in case of any error creating the string (you should notify on
 * 			an error using MTM_OUT_OF_MEMORY
 */
const char* mtmPrintUser(const char* userName,
                         int age,
                         List friendsNames,
                         List seriesNames);
